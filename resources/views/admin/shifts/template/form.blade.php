<div class="row">
    <div class="col-12">
        <div class="form-group">
            ...
            <input type="text" name="name" id="name" class="form-control" placeholder="Ingrese el nombre del turno" value="{{ isset($shift) ? $shift->name : old('name') }}" required>
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <div class="input-group">
                    <input type="time" name="hora_in" id="hora_in" class="form-control" value="{{ isset($shift) ? $shift->hora_in : old('hora_in') }}" required>
                </div>
            ...
            <div class="form-group col-md-6">
                ...
                <div class="input-group">
                    <input type="time" name="hora_out" id="hora_out" class="form-control" value="{{ isset($shift) ? $shift->hora_out : old('hora_out') }}" required>
                </div>
                <small class="form-text text-muted">Formato de 24 horas</small>
            </div>
        </div>
        ...
        <div class="form-group mt-3">
            ...
            <textarea name="description" id="description" class="form-control" placeholder="Ingrese una descripción del turno (opcional)" rows="3">{{ isset($shift) ? $shift->description : old('description') }}</textarea>
