...
<script>
    ...
    window.showScheduleModal = function() {
        ...
        // Cargar vehículos y empleados DESPUÉS de que el modal esté visible
        setTimeout(function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if(response.success && response.data && response.data.length > 0) {
                    ...
                    options += '<option value="">No hay vehículos disponibles</option>';
                }
    ...
    function saveSchedule() {
        ...
        $.ajax({
            ...
            error: function(xhr) {
                console.error('❌ Error en saveSchedule:', xhr);
