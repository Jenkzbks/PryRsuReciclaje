...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <div>
            ...
            <p class="text-muted mb-0">Modificar: {{ $employeeType->name }}</p>
        </div>
        <div>
            <a href="{{ route('personnel.employee-types.show', $employeeType) }}" class="btn btn-info">
...
@section('content')
    <form action="{{ route('personnel.employee-types.update', $employeeType) }}" method="POST" id="employeeTypeForm">
        @csrf
        @method('PUT')
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      name="description" 
                                      rows="3" 
                                      placeholder="Describe las responsabilidades y características de este tipo de empleado...">{{ old('description', $employeeType->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('level') is-invalid @enderror" 
                                        ...
                                        <option value="1" {{ old('level', $employeeType->level) == '1' ? 'selected' : '' }}>Directivo</option>
                                        <option value="2" {{ old('level', $employeeType->level) == '2' ? 'selected' : '' }}>Gerencial</option>
                                        <option value="3" {{ old('level', $employeeType->level) == '3' ? 'selected' : '' }}>Supervisión</option>
                                        <option value="4" {{ old('level', $employeeType->level) == '4' ? 'selected' : '' }}>Operativo</option>
                                        <option value="5" {{ old('level', $employeeType->level) == '5' ? 'selected' : '' }}>Apoyo</option>
                                    </select>
                                    @error('level')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" 
                                           ...
                                           id="sort_order" 
                                           name="sort_order" 
                                           value="{{ old('sort_order', $employeeType->sort_order ?? 0) }}" 
                                           min="0">
                                    @error('sort_order')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" 
                                               ...
                                               name="active" 
                                               value="1" 
                                               {{ old('active', $employeeType->active) ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" 
                                               ...
                                               name="protected" 
                                               value="1" 
                                               {{ old('protected', $employeeType->protected) ? 'checked' : '' }}>
            ...
            <div class="col-lg-4">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="color" 
                                       ...
                                       id="color" 
                                       name="color" 
                                       value="{{ old('color', $employeeType->color ?? '#007bff') }}" 
                                       style="height: 40px;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   ...
                                   id="icon" 
                                   name="icon" 
                                   value="{{ old('icon', $employeeType->icon ?? 'fas fa-user') }}" 
                        ...
                        <div class="form-group">
                            ...
                            <div class="preview-badge p-3 border rounded text-center">
                                <span class="badge badge-pill p-2" id="badge-preview" style="background-color: {{ $employeeType->color ?? '#007bff' }}; color: white;">
                                    <i class="{{ $employeeType->icon ?? 'fas fa-user' }}" id="icon-preview"></i>
                                    <span id="name-preview">{{ $employeeType->name }}</span>
                                </span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <div class="text-center">
                            <h4 class="text-primary">{{ $employeeType->employees->count() }}</h4>
                            <p class="text-muted">empleados con este tipo</p>
                            @if($employeeType->employees->count() > 0)
                                <a href="{{ route('personnel.employee-types.show', $employeeType) }}" class="btn btn-outline-primary btn-sm">
                                    Ver empleados
                                </a>
                            @endif
                        </div>
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ route('personnel.employee-types.show', $employeeType) }}" class="btn btn-info btn-block">
                            <i class="fas fa-eye"></i> Ver Detalles
                        </a>
