...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('schedulings/group-info/{group}', [SchedulingController::class, 'groupInfo'])
        ->name('schedulings.group-info');

    Route::post('schedulings/check-availability', [SchedulingController::class, 'checkAvailability'])
        ->name('schedulings.check-availability');

    // ===== MANTENIMIENTOS =====
    Route::resource('maintenances', MaintenanceController::class);

    // ===== HORARIOS DE MANTENIMIENTO (ANIDADOS) =====
  Route::prefix('maintenances/{maintenance}')
    ->name('maintenances.')
    ->group(function () {
        // HORARIOS
        Route::get('schedules', [MaintenanceScheduleController::class, 'index'])
            ->name('schedules.index');
        Route::get('schedules/create', [MaintenanceScheduleController::class, 'create'])
            ->name('schedules.create');
        Route::post('schedules', [MaintenanceScheduleController::class, 'store'])
            ->name('schedules.store');
        Route::get('schedules/{schedule}/edit', [MaintenanceScheduleController::class, 'edit'])
            ->name('schedules.edit');
        ...
        // REGISTROS (fechas generadas)
        Route::get('records/{record}/edit', [MaintenanceRecordController::class, 'edit'])
            ->name('records.edit');
        Route::put('records/{record}', [MaintenanceRecordController::class, 'update'])
            ->name('records.update');
        Route::delete('records/{record}', [MaintenanceRecordController::class, 'destroy'])
