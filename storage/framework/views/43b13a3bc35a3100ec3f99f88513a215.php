...
<?php $__env->startSection('content_header'); ?>
    ...
    <h1 class="h3 mb-1 font-weight-bold"><i class="fas fa-list"></i> Gestión de Motivos</h1>
...
<script>
    $(document).ready(function() {
        $('#reasons-table').DataTable({
            'ajax': '<?php echo e(route('admin.reasons.index')); ?>',
            'columns': [
                { data: 'name' },
                // { data: 'description' },
    ...
    $('#btnRegistrar').click(function() {
        $.ajax({
            url: "<?php echo e(route('admin.reasons.create')); ?>",
            type: 'GET',
    ...
    $(document).on('click', '.btnEditar', function() {
        var id = $(this).attr('id');
        $.ajax({
            url: "<?php echo e(route('admin.reasons.edit', 'id')); ?>".replace('id', id),
            type: 'GET',
            success: function(response) {
                $('#modal .modal-body').html(response);
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\crist\OneDrive\Escritorio\TADS\PryFinal\PryRsuReciclaje\resources\views/admin/reasons/index.blade.php ENDPATH**/ ?>