...
<div class="d-flex justify-content-between align-items-center">
  <div>
    <h1>Horarios de: <?php echo e($maintenance->name); ?></h1>
    <small class="text-muted">Rango: <?php echo e($maintenance->range_text); ?></small>
  </div>
  <div>
    <a href="<?php echo e(route('admin.maintenances.index')); ?>" class="btn btn-outline-secondary mr-2">
      <i class="fas fa-arrow-left"></i> Volver a mantenimientos
    </a>
    <a href="<?php echo e(route('admin.maintenances.schedules.create', $maintenance)); ?>" class="btn btn-primary">
        ...
        <tbody>
          <?php $__empty_1 = true; $__currentLoopData = $schedules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr>
              ...
              <td><?php echo e(optional($s->driver)->lastnames); ?> <?php echo e(optional($s->driver)->names); ?></td>
              <td><?php echo e($s->start_time); ?></td>
              <td><?php echo e($s->end_time); ?></td>
              <td><?php echo e($s->maintenance_type); ?></td>
              
              <td class="d-flex">
                <a href="<?php echo e(route('admin.maintenances.schedules.edit', [$maintenance, $s])); ?>"
                ...
                <button type="button"
                        ...
                        data-action="<?php echo e(route('admin.maintenances.schedules.destroy', [$maintenance, $s])); ?>"
                        data-info="Vehículo <?php echo e($s->vehicle->plate ?? '-'); ?>, <?php echo e($s->day_of_week); ?> <?php echo e($s->start_time); ?> - <?php echo e($s->end_time); ?>">
      ...
      <table class="table table-sm table-striped mb-0">
        ...
        <tbody>
          <?php $__empty_1 = true; $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr>
              <td><?php echo e($r->maintenance_date->format('Y-m-d')); ?></td>
        ...
        <?php endif; ?>
              ...
              <td>
                <?php if($r->image_url): ?>
                  <img src="<?php echo e(asset('storage/'.$r->image_url)); ?>"
              ...
              <td class="d-flex">
                <a href="<?php echo e(route('admin.maintenances.records.edit', [$maintenance, $r])); ?>"
                   class="btn btn-sm btn-outline-primary mr-2"
                   title="Editar">
                  <i class="fas fa-edit"></i>
                </a>
                ...
                <button type="button"
                        ...
                        title="Eliminar"
                        data-action="<?php echo e(route('admin.maintenances.records.destroy', [$maintenance, $r])); ?>"
                        data-date="<?php echo e($r->maintenance_date->format('Y-m-d')); ?>">
                  <i class="fas fa-trash"></i>
                </button>
              </td>
            </tr>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\USAT 2025-2\topicos\PryFINAL\PryRsuReciclaje\resources\views/maintenanceschedules/index.blade.php ENDPATH**/ ?>