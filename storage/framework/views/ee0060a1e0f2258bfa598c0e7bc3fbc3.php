<div class="form-group">
    <?php echo Form::label('name', 'Nombre de la Zona'); ?>

    <?php echo Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Nombre de la zona', 'required']); ?>
...
<div class="form-group">
    <?php echo Form::label('average_waste', 'Residuos promedio (Tn)'); ?>

    <div class="input-group">
        <?php echo Form::number('average_waste', null, ['class' => 'form-control', 'placeholder' => 'Ingrese residuos promedio', 'step' => '0.01', 'min' => '0', 'required']); ?>
...
<div class="form-group">
    ...
    <div class="custom-control custom-switch">
        <input type="checkbox" class="custom-control-input" id="statusSwitch" <?php echo e((isset($zone) ? $zone->status == '1' : true) ? 'checked' : ''); ?>>
        <label class="custom-control-label" for="statusSwitch">Activo</label>
        <input type="hidden" name="status" id="statusHidden" value="<?php echo e(isset($zone) ? $zone->status : '1'); ?>">
    </div>
</div>
<hr>
<div class="row mt-3">
...
$(function() {
    ...
    <?php if(isset($zone)): ?>
        ...
        depId = <?php echo json_encode(optional(optional($zone->district)->province)->department_id ?? '', 15, 512) ?>;
        provId = <?php echo json_encode(optional($zone->district)->province_id ?? '', 15, 512) ?>;
        distId = <?php echo json_encode($zone->district_id ?? '', 15, 512) ?>;
        if(depId) {
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\crist\OneDrive\Escritorio\TADS\PryFinal\PryRsuReciclaje\resources\views/admin/zones_jenkz/template/form.blade.php ENDPATH**/ ?>