<?php $__env->startSection('title', 'Gestión de Personal'); ?>
...
<?php $__env->startSection('content_header'); ?>
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div class="btn-group">
            ...
            <a href="<?php echo e(route('admin.personnel.attendances.dashboard')); ?>" class="btn btn-success">
                <i class="fas fa-clock"></i> Asistencias Hoy
            </a>
            <a href="<?php echo e(route('admin.personnel.vacations.index', ['status' => 'pending'])); ?>" class="btn btn-warning">
    ...
    <div class="row" id="dashboard-stats">
        <div class="col-lg-3 col-md-6">
            <div class="small-box bg-info">
                ...
                <a href="<?php echo e(route('admin.personnel.employees.index')); ?>" class="small-box-footer">
        ...
        <div class="col-lg-3 col-md-6">
            <div class="small-box bg-success">
                ...
                <a href="<?php echo e(route('admin.personnel.employees.index', ['status' => 'active'])); ?>" class="small-box-footer">
        ...
        <div class="col-lg-3 col-md-6">
            <div class="small-box bg-warning">
                ...
                <a href="<?php echo e(route('admin.personnel.vacations.index', ['status' => 'pending'])); ?>" class="small-box-footer">
        ...
        <div class="col-lg-3 col-md-6">
            <div class="small-box bg-danger">
                ...
                <a href="<?php echo e(route('admin.personnel.contracts.index', ['expiring_soon' => 1])); ?>" class="small-box-footer">
        ...
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-footer">
                    <a href="<?php echo e(route('admin.personnel.attendances.dashboard')); ?>" class="btn btn-primary btn-block">
        ...
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-footer">
                    <div class="row">
                        <div class="col-6">
                            <a href="<?php echo e(route('admin.personnel.contracts.index')); ?>" class="btn btn-outline-primary btn-block">
                                <i class="fas fa-list"></i> Ver Contratos
                            </a>
                        </div>
                        <div class="col-6">
                            <a href="<?php echo e(route('admin.personnel.employees.export')); ?>" class="btn btn-outline-success btn-block">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="list-group">
                        <a href="<?php echo e(route('admin.personnel.employees.create')); ?>" class="list-group-item list-group-item-action">
                            <i class="fas fa-user-plus text-primary"></i> Registrar Empleado
                        </a>
                        <a href="<?php echo e(route('admin.personnel.contracts.create')); ?>" class="list-group-item list-group-item-action">
                            <i class="fas fa-file-signature text-success"></i> Nuevo Contrato
                        </a>
                        <a href="<?php echo e(route('admin.personnel.vacations.create')); ?>" class="list-group-item list-group-item-action">
                            <i class="fas fa-calendar-plus text-warning"></i> Solicitar Vacaciones
                        </a>
                        <a href="<?php echo e(route('attendance-kiosk.index')); ?>" class="list-group-item list-group-item-action" target="_blank">
...
<?php $__env->startSection('js'); ?>
    ...
    <script>
        ...
        function loadDashboardStats() {
            ...
            $('#total-employees').text('<?php echo e(\App\Models\Employee::count()); ?>');
            $('#active-employees').text('<?php echo e(\App\Models\Employee::where("status", 1)->count()); ?>');
        ...
        function loadAttendanceToday() {
            ...
            const totalEmployees = <?php echo e(\App\Models\Employee::where('status', 1)->count()); ?>;
        ...
        function loadEmployeeTypesStats() {
            ...
            const html = `
                <?php $__currentLoopData = \App\Models\EmployeeType::withCount(['employees' => function($query) { $query->where('status', 1); }])->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="list-group-item d-flex justify-content-between align-items-center">
                    <div>
                        <strong><?php echo e($type->name); ?></strong>
                        <?php if($type->is_protected): ?>
                            <i class="fas fa-shield-alt text-warning ml-1" title="Protegido"></i>
                        <?php endif; ?>
                        <br>
                        <small class="text-muted"><?php echo e($type->employees_count); ?> empleados</small>
                    </div>
                    <div class="text-right">
                        <span class="badge badge-primary badge-pill"><?php echo e($type->employees_count); ?></span>
                    </div>
                </div>
        ...
        function loadEmployeesForSelect() {
            ...
            <?php $__currentLoopData = \App\Models\Employee::where('status', 1)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                select.append('<option value="<?php echo e($employee->id); ?>"><?php echo e($employee->names); ?> <?php echo e($employee->lastnames); ?></option>');
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        }
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\USAT 2025-2\topicos\PryFINAL\PryRsuReciclaje\resources\views/personnel/dashboard.blade.php ENDPATH**/ ?>