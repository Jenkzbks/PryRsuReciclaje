...
<?php $__env->startSection('content_header'); ?>
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div class="d-flex align-items-center gap-2">
                <a href="<?php echo e(route('admin.zonesjenkz.map')); ?>" class="btn btn-info mr-2">
                <i class="fas fa-map-marked-alt"></i> Mapa de Zonas
                </a>
            <a href="<?php echo e(route('admin.zonesjenkz.create')); ?>" class="btn btn-primary">
...
<script>
    $(document).ready(function() {
        var table = $('#zones-table').DataTable({
            ajax: '<?php echo e(route('admin.zonesjenkz.index')); ?>',
            columns: [
                { data: 'name' },
            ...
            setTimeout(function() {
                if (!window._mapaZonasLoaded) {
                    ...
                    function renderMapaZonas() {
                        ...
                        $.getJSON("<?php echo e(route('admin.zonesjenkz.index')); ?>", function(resp) {
                            if (resp.data) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\crist\OneDrive\Escritorio\TADS\PryFinal\PryRsuReciclaje\resources\views/admin/zones_jenkz/index.blade.php ENDPATH**/ ?>