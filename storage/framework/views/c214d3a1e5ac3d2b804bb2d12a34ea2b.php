<?php $__env->startSection('title', 'Nuevo Tipo de Empleado'); ?>
...
<?php $__env->startSection('content'); ?>
    <form action="<?php echo e(route('personnel.employee-types.store')); ?>" method="POST" id="employeeTypeForm">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                      ...
                                      name="description" 
                                      rows="3" 
                                      placeholder="Describe las responsabilidades y características de este tipo de empleado..."><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                        ...
                                        <option value="1" <?php echo e(old('level') == '1' ? 'selected' : ''); ?>>Directivo</option>
                                        <option value="2" <?php echo e(old('level') == '2' ? 'selected' : ''); ?>>Gerencial</option>
                                        <option value="3" <?php echo e(old('level') == '3' ? 'selected' : ''); ?>>Supervisión</option>
                                        <option value="4" <?php echo e(old('level') == '4' ? 'selected' : ''); ?>>Operativo</option>
                                        <option value="5" <?php echo e(old('level') == '5' ? 'selected' : ''); ?>>Apoyo</option>
                                    </select>
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" 
                                               ...
                                               name="protected" 
                                               value="1" 
                                               <?php echo e(old('protected') ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                                       id="color" 
                                       name="color" 
                                       value="<?php echo e(old('color', '#007bff')); ?>" 
                                       style="height: 40px;">
...
unset($__errorArgs, $__bag); ?>" 
                                   id="icon" 
                                   name="icon" 
                                   value="<?php echo e(old('icon', 'fas fa-user')); ?>" 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\USAT 2025-2\topicos\PryFINAL\PryRsuReciclaje\resources\views/personnel/employee-types/create.blade.php ENDPATH**/ ?>