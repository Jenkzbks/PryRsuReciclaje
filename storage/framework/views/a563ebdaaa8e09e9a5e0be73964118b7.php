...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#groups-table').DataTable({
            'ajax': '<?php echo e(route('admin.personnel.employeegroups.index')); ?>',
            'columns': [
        ...
        $('#btnRegistrar').click(function() {
            $.ajax({
                url: "<?php echo e(route('admin.personnel.employeegroups.create')); ?>",
                type: 'GET',
        ...
        $(document).on('click', '.btnEditar', function() {
            var id = $(this).attr('id');
            $.ajax({
                url: "<?php echo e(route('admin.personnel.employeegroups.edit', 'id')); ?>".replace('id', id),
                type: 'GET',
                success: function(response) {
                    $('#modal .modal-body').html(response);
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\crist\OneDrive\Escritorio\TADS\PryFinal\PryRsuReciclaje\resources\views/personnel/employeegroup/index.blade.php ENDPATH**/ ?>