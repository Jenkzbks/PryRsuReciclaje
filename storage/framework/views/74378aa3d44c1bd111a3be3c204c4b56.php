...
<div class="form-group">
    ...
    <div class="input-group">
        <div class="input-group-prepend">
            <input type="color" id="color_picker" value="<?php echo e(old('code', $color->code ?? '#ff0000')); ?>" style="height: 38px;">        </div>
...
<?php /**PATH C:\Users\crist\OneDrive\Escritorio\TADS\PryFinal\PryRsuReciclaje\resources\views/admin/colors/template/form.blade.php ENDPATH**/ ?>