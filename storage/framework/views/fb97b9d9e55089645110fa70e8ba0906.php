<div class="row">
    ...
    <div class="col-md-5">
        ...
        <div class="mb-3">
            ...
            <?php if(isset($vehicle) && $vehicle->images->isNotEmpty()): ?>
                <img src="<?php echo e(asset('storage/' . $vehicle->images->first()->image)); ?>" alt="Imagen principal" class="img-fluid rounded mb-2" id="image_preview">
            <?php else: ?>
                <img src="<?php echo e(asset('storage/vehicles/noimage.jpg')); ?>" alt="Imagen principal" class="img-fluid rounded mb-2" id="image_preview">
            <?php endif; ?>
        ...
        <div class="row">
            <?php for($i = 0; $i < 3; $i++): ?>
                <div class="col-4 mb-2">
                    ...
                    ?>
                    <img src="<?php echo e($galleryImage ? asset('storage/' . $galleryImage->image) : asset('storage/vehicles/noimage.jpg')); ?>"
...
<?php /**PATH F:\USAT 2025-2\topicos\PryFINAL\PryRsuReciclaje\resources\views/admin/vehicles/template/form.blade.php ENDPATH**/ ?>