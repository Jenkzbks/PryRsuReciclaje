<?php $__env->startSection('title', 'Agregar Zona'); ?>
...
<?php $__env->startSection('content'); ?>
    <form method="POST" action="<?php echo e(route('admin.zones.store')); ?>" id="zoneForm">
        <?php echo csrf_field(); ?>
        <div class="row">
            <!-- Formulario -->
            <div class="col-md-5">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\USAT 2025-2\topicos\PryFINAL\PryRsuReciclaje\resources\views/admin/zones/create.blade.php ENDPATH**/ ?>