...
<?php $__env->startSection('content'); ?>
    <form method="POST" action="<?php echo e(route('admin.zones.update', $zone)); ?>" id="zoneForm">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                   value="<?php echo e(old('name', $zone->name)); ?>"
                                   required>
...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <option value="<?php echo e($department->id); ?>" 
                                            <?php echo e($selectedDepartmentId == $department->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                <?php $__currentLoopData = $provinces; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $province): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <option value="<?php echo e($province->id); ?>" 
                                            <?php echo e($selectedProvinceId == $province->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <?php $__currentLoopData = $districts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $district): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($district->id); ?>" 
                                            <?php echo e(old('district_id', $zone->district_id) == $district->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                                      rows="3"><?php echo e(old('description', $zone->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" 
                                           id="vertices_count" 
                                           class="form-control" 
                                           value="<?php echo e($zone->polygon_coordinates ? count($zone->polygon_coordinates) : 0); ?>" 
                                           readonly>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" 
                                           id="area_display" 
                                           class="form-control" 
                                           value="<?php echo e(number_format($zone->area ?? 0, 2)); ?>" 
                                           readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <input type="hidden" name="polygon_coordinates" id="polygon_coordinates" value="<?php echo e(json_encode($zone->polygon_coordinates)); ?>">
                        <input type="hidden" name="area" id="area" value="<?php echo e($zone->area); ?>">
                    </div>
                </div>
            </div>
        ...
        <div class="row mt-4">
            <div class="col-12">
                <div class="d-flex justify-content-end">
                    <a href="<?php echo e(route('admin.zones.index')); ?>" class="btn btn-secondary mr-2">
                        Cancelar
                    </a>
...
<?php $__env->startSection('js'); ?>
    ...
    <script>
        ...
        let existingCoordinates = <?php echo json_encode($zone->polygon_coordinates, 15, 512) ?>;
        ...
        function loadExistingZones() {
            const currentZoneId = <?php echo e($zone->id); ?>;
            ...
            $('#department_id').change(function() {
                ...
                if (departmentId) {
                    ...
                    $.get(`/admin/api/provinces/${departmentId}`, function(provinces) {
                        const selectedProvinceId = <?php echo e(old('province_id', $zone->district ? $zone->district->province_id : ($zone->province_id ?? 'null'))); ?>;
                    ...
                    $.get(`/admin/api/districts/${provinceId}`, function(districts) {
                        if (districts.length > 0) {
                            ...
                            districts.forEach(function(district) {
                                const selected = district.id == <?php echo e(old('district_id', $zone->district_id) ?? 'null'); ?> ? 'selected' : '';
                                $('#district_id').append(
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\USAT 2025-2\topicos\PryFINAL\PryRsuReciclaje\resources\views/admin/zones/edit.blade.php ENDPATH**/ ?>