...
<script>
    $(document).ready(function() {
        ...
        $('#shifts-table').DataTable({
            'ajax': '<?php echo e(route('admin.shifts.index')); ?>',
            'columns': [
                { "data": "name" },
                { "data": "description" },
                {
        ...
        $('#btnRegistrar').click(function() {
            $.ajax({
                url: "<?php echo e(route('admin.shifts.create')); ?>",
                type: 'GET',
        ...
        $(document).on('click', '.btnEditar', function() {
            var id = $(this).attr('id');
            $.ajax({
                url: "<?php echo e(route('admin.shifts.edit', 'id')); ?>".replace('id', id),
                type: 'GET',
                success: function(response) {
                    $('#modal .modal-body').html(response);
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\crist\OneDrive\Escritorio\TADS\PryFinal\PryRsuReciclaje\resources\views/admin/shifts/index.blade.php ENDPATH**/ ?>